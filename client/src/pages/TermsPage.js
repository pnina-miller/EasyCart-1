  ...
  return (
    <>
      ...
      <Container>
        ...
        <br />
        Your privacy is important to us. It is Easycart's policy to respect your
        privacy regarding any information we may collect from you across our
        website, <a href="https://easycart.direct">easycart.direct</a>, and
        ...
        <br />
        Easycart Data Controller
        <br />
        Ohev Tzion
        <br />
        <a href="mailto:info@leader.codes">:info@leader.codes</a>
        <br />
        This policy is effective as of March 24, 2021.
        <br />
        <br />
      </Container>
      <Footer/>
